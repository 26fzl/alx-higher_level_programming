...
class TestMaxInteger(unittest.TestCase):
    ...
    def test_regular(self):
        """Test with a regular list of integers: should return the max result"""
        l = [1, 2, 3, 4, 5]
        result = max_integer(l)
        self.assertEqual(result, 5)

    def test_not_int(self):
        """Test with a list containing non-integers and intg:
        should raise a TypeError exception"""
        l = ["a", "b", 9]
        self.assertRaises(TypeError, max_integer, l)

    def test_empty(self):
        """Test with an empty list: None as return"""
        l = []
        result = max_integer(l)
        self.assertEqual(result, None)

    def test_negative(self):
        """Test with a list of negative values: should return maximum"""
        l = [-2, -6, -1]
        result = max_integer(l)
        self.assertEqual(result, -1)

    def test_float(self):
        """Test with a list of mixed intg and floats: should return the max"""
        l = [3, 4.5, 2]
        result = max_integer(l)
    ...
    def test_unique(self):
        """Test with a list of one int: should return  value of this intg"""
        l = [45]
        result = max_integer(l)
